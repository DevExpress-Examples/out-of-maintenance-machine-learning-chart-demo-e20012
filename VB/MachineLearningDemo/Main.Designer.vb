...
'			Me.buttonLoadPlot.Click += New System.EventHandler(Me.buttonLoadPlot_Click);
			' 
			' chartLinear
			' 
...
'			Me.buttonClusteStudents.Click += New System.EventHandler(Me.buttonClusteStudents_Click);
			' 
			' buttonPredict
			' 
...
'			Me.buttonPredict.Click += New System.EventHandler(Me.buttonPredict_Click);
			' 
			' buttonSaveModel
			' 
...
'			Me.buttonSaveModel.Click += New System.EventHandler(Me.buttonSaveModel_Click);
			' 
			' buttonGenerate
			' 
...
'			Me.buttonGenerate.Click += New System.EventHandler(Me.buttonGenerate_Click);
			' 
			' buttonLoad
			' 
...
'			Me.buttonAnimate.Click += New System.EventHandler(Me.buttonAnimate_Click);
			' 
			' buttonUpdate
			' 
...
'			Me.buttonUpdate.Click += New System.EventHandler(Me.buttonUpdate_Click);
			' 
			' buttonAssign
			' 
...
'			Me.buttonAssign.Click += New System.EventHandler(Me.buttonAssign_Click);
			' 
			' buttonInitCluster
			' 
...
'			Me.buttonInitCluster.Click += New System.EventHandler(Me.buttonInitCluster_Click);
			' 
...
'			Me.buttonGenerateCluster.Click += New System.EventHandler(Me.buttonGenerateCluster_Click);
			' 
			' chartCluster
			' 
...
'			Me.buttonSaveDescription.Click += New System.EventHandler(Me.buttonSaveDescription_Click);
			' 
			' buttonLoadFeeds
			' 
...
'			Me.buttonLoadFeeds.Click += New System.EventHandler(Me.buttonLoadFeeds_Click);
			' 
...
'			Me.buttonClusterFeeds.Click += New System.EventHandler(Me.buttonClusterFeeds_Click);
			' 
			' defaultLookAndFeel1
			' 
